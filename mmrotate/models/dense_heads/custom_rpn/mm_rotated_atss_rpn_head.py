...
class MMRotatedATSSRPNHead(MMRotatedATSSHead):
    def __init__(self, version='oc', **kwargs):
        super(MMRotatedATSSRPNHead, self).__init__(
            num_classes=1,
            init_cfg=dict(
                type='Normal',
                layer='Conv2d',
    ...
    def loss(self,
        ...
        """
        losses = super(MMRotatedATSSRPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def _bbox_post_process(self, mlvl_scores, mlvl_bboxes, mlvl_valid_anchors,
        ...
        if proposals.numel() > 0:
            ...
            #nms_cfg = dict(type='nms', iou_thr=cfg.iou_threshold)
