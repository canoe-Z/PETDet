...
from mmrotate.core import obb2xyxy, rotated_anchor_inside_flags,multiclass_nms_rotated
...
class OrientedRetinaHead(RotatedAnchorHead):
    ...
    def __init__(self,
        ...
        super(OrientedRetinaHead, self).__init__(
            num_classes,
            in_channels,
