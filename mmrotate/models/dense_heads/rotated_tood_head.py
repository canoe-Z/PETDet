...
class TOODHead(RotatedATSSHead):
    ...
    def _init_layers(self):
        ...
        self.tood_reg = nn.Conv2d(
            self.feat_channels, self.num_base_priors * self.reg_dim, 3, padding=1)
    ...
    def forward(self, feats):
        ...
        for idx, (x, scale, stride) in enumerate(
            ...
            if self.anchor_type == 'anchor_free':
                ...
                reg_dist = reg_dist.permute(0, 2, 3, 1).reshape(-1, 5)
                ##TODO
                bbox_pred = self.bbox_coder.decode(anchor, reg_dist).reshape(
