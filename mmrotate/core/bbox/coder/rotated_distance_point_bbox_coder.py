...
class RotatedDistancePointBBoxCoder(BaseBBoxCoder):
    ...
    def encode(self, points, gt_bboxes, angle_range='oc', edge_swap=True, max_dis=None, eps=0.1):
        ...
        return rbbox2distance(points, gt_bboxes, angle_range, edge_swap, max_dis, eps)

    def decode(self, points, pred_bboxes, angle_range='oc', edge_swap=True, max_shape=None):
        ...
        if self.clip_border is False:
            max_shape = None
        return distance2rbbox(points, pred_bboxes, angle_range, edge_swap, max_shape)


def rbbox2distance(points, gt, angle_range='oc', edge_swap=True, max_dis=None, eps=0.1):
...
def distance2rbbox(points, distance, angle_range='oc', edge_swap=True, max_shape=None):
    #batch_convert = len(distance.shape) == 3
    ...
    ctr = points + offset
    theta = norm_angle(theta, angle_range)
