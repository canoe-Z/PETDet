...
class WorldViewDataset(DOTADataset):
    """WorldViewDataset dataset for detection.
    ...
    def __init__(self,
        ...
        super(WorldViewDataset, self).__init__(
            ann_file, pipeline, filter_empty_gt=False, **kwargs)
